...
class ChairmanSignup extends StatefulWidget {
  const ChairmanSignup({super.key});

  @override
  State<ChairmanSignup> createState() => _ChairmanSignupState();
}

class _ChairmanSignupState extends State<ChairmanSignup> {
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              SiginComp(name: "Chairman name", controller:username, obstrue:false, icon: Icon(Icons.person)),
              SizedBox(height: 15,),
              SiginComp(
